...
from src.model2 import MULTModel
...
parser.add_argument('--num_heads', type=int, default=4, help='number of heads for the transformer network (default: 5)')
...
parser.add_argument('--gpu', type=str, default='1', help='Select gpu to use')
...
def main():
    ...
    if args.use_resume:
        ...
        checkpoint = torch.load(os.path.join(args.resume_dir, 'best_model_48.00.pth'))
